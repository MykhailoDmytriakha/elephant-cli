...
# ONBOARDING.md into whatever file this harness reads — the tool explains itself from there.
set -euo pipefail
...
printf '%s\n' \
  ...
  "          paste   the block under the line in \"$HERE/ONBOARDING.md\" into the project's CLAUDE.md / AGENTS.md / GEMINI.md" \
