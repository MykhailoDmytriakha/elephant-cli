...
class Discovery(unittest.TestCase):
    ...
    def test_upper_mixed_and_lower_names_are_detected(self):
        names = [
            "2026-08-27-ABCDE-12345-sre-sdk-ingestion",
            "2026-08-27-abcde-12345-sre-sdk-ingestion2",
            "2026-08-27-AbcDe-12345-SRE-SDK-ingestion3",
        ]
        for n in names:
    ...
    def test_case_list_and_check_print_diagnostics(self):
        ...
        make_case(self.root, "2026-08-27-ABCDE-12345-sre-sdk-ingestion")
    ...
    def test_hand_and_use_with_uppercase_dir(self):
        make_case(self.root, "2026-08-27-ABCDE-12345-sre-sdk-ingestion")
        self.assertEqual(store.hand(self.root).name, "2026-08-27-ABCDE-12345-sre-sdk-ingestion")
        code, out, err = run("case", "use", "abcde-12345-sre-sdk-ingestion")  # lowercase suffix
        self.assertEqual(code, 0, err)
        code, out, _ = run()
        self.assertIn("ABCDE-12345-sre-sdk-ingestion", out.splitlines()[0])
