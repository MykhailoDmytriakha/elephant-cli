...
PHASE_BEATS = {
    ...
    "execute": [
        ("назван активный узел — один", "agent", "status: active в nodes/<узел>.md", "light",
         "работа идёт узел за узлом: start → делать → критерии по ходу → следы к узлу → остановка "
...
PHASE_BRIEF = {
    ...
    "execute":  "узел за узлом: активный один · критерии по ходу · следы к узлу · остановки по плану · эстафета",
